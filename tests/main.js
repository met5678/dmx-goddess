...
var prepareBuffers = function() {
  ...
  var index = frame % spacing;
  for(var led=index; led < LEDs; led += spacing) {
    var channel = led*3+5;
    var excludeColor = (Math.random()*3)|0;
    sendBuffer[channel] = excludeColor == 0 ? 0 : 255;
    sendBuffer[channel+1] = excludeColor == 1 ? 0 : 255;
    sendBuffer[channel+2] = excludeColor == 2 ? 0 : 255;
  }
